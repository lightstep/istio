...
type ProxyConfig struct {
	...
	LightstepAccessToken string `protobuf:"bytes,20,opt,name=lightstep_access_token,json=lightstepAccessToken,proto3" json:"lightstep_access_token,omitempty"`
}
...
func (m *ProxyConfig) GetLightstepAccessToken() string {
	if m != nil {
		return m.LightstepAccessToken
	}
	return ""
}
...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LightstepAccessToken) > 0 {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.LightstepAccessToken)))
		i += copy(dAtA[i:], m.LightstepAccessToken)
	}
	return i, nil
}
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LightstepAccessToken", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LightstepAccessToken = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorConfig = []byte{
	...
	,
}

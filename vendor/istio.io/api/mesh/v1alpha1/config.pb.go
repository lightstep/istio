...
type ProxyConfig struct {
	...
	LightstepAddress string `protobuf:"bytes,19,opt,name=lightstep_address,json=lightstepAddress,proto3" json:"lightstep_address,omitempty"`
	// Path to the lightstep access token file.
	LightstepAccessTokenFile string `protobuf:"bytes,20,opt,name=lightstep_access_token_file,json=lightstepAccessTokenFile,proto3" json:"lightstep_access_token_file,omitempty"`
}
...
func (m *ProxyConfig) GetLightstepAddress() string {
	if m != nil {
		return m.LightstepAddress
	}
	return ""
}

func (m *ProxyConfig) GetLightstepAccessTokenFile() string {
	if m != nil {
		return m.LightstepAccessTokenFile
	}
	return ""
}
...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LightstepAddress) > 0 {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.LightstepAddress)))
		i += copy(dAtA[i:], m.LightstepAddress)
	}
	if len(m.LightstepAccessTokenFile) > 0 {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.LightstepAccessTokenFile)))
		i += copy(dAtA[i:], m.LightstepAccessTokenFile)
	}
	return i, nil
}
...
func (m *ProxyConfig) Size() (n int) {
	...
	l = len(m.LightstepAddress)
	if l > 0 {
		n += 2 + l + sovConfig(uint64(l))
	}
	l = len(m.LightstepAccessTokenFile)
	if l > 0 {
		n += 2 + l + sovConfig(uint64(l))
	}
	return n
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LightstepAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LightstepAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LightstepAccessTokenFile", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LightstepAccessTokenFile = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorConfig = []byte{
	...
	,
}
